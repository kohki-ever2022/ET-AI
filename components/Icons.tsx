...
export const SpinnerIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg className={`${className} animate-spin motion-reduce:animate-none`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
...
export const QuoteIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="currentColor" viewBox="0 0 16 16">
    <path d="M12 12a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1h-1.388c0-.355.02-1.724.03-3.262.014-1.588.025-2.97.03-4.292a1 1 0 0 0-1-1h-1.373a1 1 0 0 0-1 1v6.988a1 1 0 0 0 1 1h1.373zm-7 0a1 1 0 0 0 1-1V8.558a1 1 0 0 0-1-1H3.612c0-.355.02-1.724.03-3.262.014-1.588.025-2.97.03-4.292a1 1 0 0 0-1-1H1.26a1 1 0 0 0-1 1v6.988a1 1 0 0 0 1 1h1.373z"/>
  </svg>
);

export const ProjectIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const SidebarToggleIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h7m-7 6h16" />
    </svg>
);
